...
class Küldemény implements Comparable<Küldemény> {
    ...
    public Küldemény(String címzett_neve, int irányítószám, String település, String utca, int házszám,
            int csomag_értéke) {
    ...
    public String toString() {
        return this.település + ", " + this.utca + " " + this.házszám + "., " + this.címzett_neve + ", "
                + this.csomag_értéke + " Ft";
    }
}
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (input.hasNextLine()) {
                ...
                Küldemény k = new Küldemény(token[0], Integer.parseInt(token[1]), token[2], token[3],
