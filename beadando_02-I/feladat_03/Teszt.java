...
public class Teszt {
    ...
    public static void main(String[] args) {
        ...
        tomb[5] = new Étterem("Almavirág Étterem", 20,
                new String[] { "Paprikás krumpli", "Tárkonyos leves", "Gesztenyepüré" });
        tomb[6] = new Étterem("Pálma Étterem", 30, new String[] { "Aranygaluska", "Tokány", "Halászlé" });
        tomb[7] = new Étterem("Posta Vendéglő", 40,
                new String[] { "Francia krémes", "Jókai-bableves", "Rakott karfiol" });
